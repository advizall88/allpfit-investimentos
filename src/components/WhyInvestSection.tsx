...
const WhyInvestSection = () => {
  ...
  return <section id="why-invest" className="bg-opacity-10 text-white min-h-screen w-full py-16 md:py-24 bg-black">
      <div className="max-w-7xl mx-auto px-4">
        <SectionHeader />
        
        <BenefitsCarousel benefitsCards={benefitsCards} expandedCard={expandedCard} onToggleCard={toggleCard} />
