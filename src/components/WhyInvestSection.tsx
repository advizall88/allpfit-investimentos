...
const WhyInvestSection = () => {
  ...
  return <section id="why-invest" className="py-16 md:py-24 text-white bg-purple-700 bg-[502a91]">
      <div className="container mx-auto px-6">
        ...
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => <div key={index} className="p-6 rounded-lg shadow-lg flex flex-col items-center text-center transform transition-transform hover:scale-105 bg-zinc-950">
              {feature.icon}
