  ...
  return <section style={{
    backgroundImage: 'url(/lovable-uploads/1b95c159-aec2-42ae-8270-00b256ef4ae0.png)'
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/4 -left-1/4 w-96 h-96 bg-allpPurple/30 rounded-full blur-3xl animate-bounce" style={{
        animationDuration: '6s'
      }} />
        <div className="absolute bottom-1/3 -right-1/4 w-80 h-80 bg-allpOrange/20 rounded-full blur-2xl animate-pulse" style={{
        animationDelay: '2s'
      }} />
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-allpPurple/15 rounded-full blur-3xl animate-ping" style={{
      ...
      <div className="container mx-auto px-6 text-center relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-112px)] md:min-h-[calc(100vh-179px)] pt-24">
        ...
        <div className="animate-fade-in mb-6">
          ...
          <div className="mt-4 animate-fade-in-delay-1">
            <p className="text-lg lg:text-xl font-poppins font-medium bg-gradient-to-r from-allpOrange/20 to-allpPurple/20 backdrop-blur-sm border border-allpOrange/30 rounded-lg px-6 py-3 max-w-2xl mx-auto text-slate-50">
              <span className="bg-gradient-to-r from-allpOrange to-orange-400 bg-clip-text text-slate-50 text-base font-bold">
