...
const ReturnOnInvestmentSection = () => {
  return <section id="roi" className="py-16 md:py-24 bg-white text-allpPurple">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <Card className="bg-allpBlack border-gray-700 shadow-xl">
            <CardHeader>
              <CardTitle className="text-2xl font-poppins font-semibold text-center text-orange-600">Aplicações Tradicionais</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              {traditionalInvestments.map((item, index) => <div key={index} className="flex justify-between items-center p-3 bg-gray-800 rounded-md">
                  ...
                  <span className="font-poppins font-bold text-lg" style={{
                color: '#e66d18'
              }}>{item.rate}</span>
                </div>)}
            </CardContent>
