...
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card'; // Assumindo que temos Card de shadcn/ui
    ...
    <section id="roi" className="py-16 md:py-24 bg-allpPurple text-white">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl md:text-4xl font-poppins font-bold text-center mb-4">
          Seu dinheiro <span className="text-allpOrange">rende mais</span> com a Allp Fit!
        </h2>
